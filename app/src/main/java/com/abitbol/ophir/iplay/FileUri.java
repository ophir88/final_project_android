...
public class FileUri implements Comparator<FileUri> {
    ...
    public FileUri(String filepath) {
        ...
        displayName = displayName.replace("__", ": ");
        displayName = displayName.replace("_", " ");
        displayName = displayName.replace(".midi", "");
    }
    ...
    public byte[] getData() {
        try {
            ...
            if (asset != null) {
                ...
                Log.d("midi", "opening file!");
//                InputStream is = new FileInputStream("/res/raw/twinkle.midi");
//                file = is;
                file = new FileInputStream(filepath);
            }
            totallen = 0;
            len = file.read(data, 0, 4096);
            Log.d("midi", "length is: " + len);
            ...
            Log.d("midi", "error opening the file...");
